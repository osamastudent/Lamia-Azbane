...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="{{asset('website/pages/images/favicon.png')}}">
    ...
    <link rel='stylesheet' href='{{asset('website/pages/css/structure.css')}}'>
    <link rel='stylesheet' href='{{asset('website/pages/css/healthy.css')}}'>
    <link rel='stylesheet' href='{{asset('website/pages/css/custom.css')}}'>

    <!-- Revolution Slider -->
    <link rel="stylesheet" href="{{asset('website/pages/plugins/rs-plugin-5.3.1/css/settings.css')}}">
...
<body class="home page-template-default page template-slider color-custom style-default button-default layout-full-width no-content-padding header-transparent minimalist-header-no sticky-header sticky-tb-color ab-hide subheader-both-center menu-link-color menuo-right menuo-no-borders mobile-tb-hide mobile-side-slide mobile-mini-mr-ll tablet-sticky mobile-sticky be-reg-2101">
                    ...
                    <div class="container">
                        <div class="column one">
                            <div class="top_bar_left clearfix">
                                <div class="logo">
                                    <a id="logo" href="{{ url('/') }}" title=" - " data-height="60" data-padding="35"><img class="logo-main scale-with-grid" src="{{asset('website/pages/images/healthy.png')}}" data-retina="{{asset('website/pages/images/retina-healthy.png')}}" data-height="56" data-no-retina /><img class="logo-sticky scale-with-grid" src="{{asset('website/pages/images/healthy.png')}}" data-retina="{{asset('website/pages/images/retina-healthy.png')}}" data-height="56" data-no-retina /><img class="logo-mobile scale-with-grid" src="{{asset('website/pages/images/healthy.png')}}" data-retina="{{asset('website/pages/images/retina-healthy.png')}}" data-height="56" data-no-retina /><img class="logo-mobile-sticky scale-with-grid" src="{{asset('website/pages/images/healthy.png')}}" data-retina="{{asset('website/pages/images/retina-healthy.png')}}" data-height="56" data-no-retina /></a>
                                </div>
                                <div class="menu_wrapper">
                                    <nav id="menu">
                                        <ul id="menu-main-menu" class="menu menu-main">
                                            ...
                                            <li>
                                                <a href="{{ url('/doctors') }}"><span>Doctors</span></a>
                                            </li>
                                            <li>
                            ...
                            <div class="top_bar_right">
                                <div class="top_bar_right_wrapper">
                                   @auth
                                    @if(auth()->user()->role_id == 2)  {{-- Only patients --}}
                                        <a href="{{ route('patient.intake.form')}}" class="action_button">
                                            Patient Intake Form <i class="icon-right-open"></i>
                                        </a>
                                        @else
                                         <a href="{{ route('patient.intake.form')}}" class="action_button">
                                            Dashboard <i class="icon-right-open"></i>
                                        </a>
                                    @endif
                                @endauth

                                @guest
                                    <a href="{{ route('login')}}" class="action_button">
                                        Patient Intake Form <i class="icon-right-open"></i>
                                    </a>
                                @endguest
                        ...
                        <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.8.1">
                            <ul>
                                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide"
                                    ...
                                    <img src="{{asset('website/pages/images/home_healthy_pic1.jpg')}}" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                                    <div class="tp-caption tp-resizeme rs-parallaxlevel-4" id="slide-1-layer-1" data-x="right" data-hoffset="-170" data-y="center" data-voffset="" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-type="image" data-responsive_offset="on"
                                        ...
                                        data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5;"><img src="{{asset('website/pages/images/home_healthy_pic2.png')}}" data-ww="754px" data-hh="810px" data-no-retina>
                                    </div>
            ...
            <div class="content_wrapper clearfix">
                <div class="sections_group">
                    <div class="entry-content">
                        <div class="section mcb-section mcb-section-0ynmkqsbv equal-height" style="padding-top:0px; padding-bottom:0px; background-color:">
                            <div class="section_wrapper mcb-section-inner">
                                <div class="wrap mcb-wrap mcb-wrap-urbp4v7ep one valign-top move-up clearfix" style="margin-top:-40px" data-mobile="no-up">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-hj4ql0s75 one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" background-color:#fff; padding:40px 40px 25px; box-shadow: 0 0px 40px rgba(239,246,250,.9); border-radius: 15px;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic3.png')}}" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="column mcb-column mcb-item-0672dmkr2 one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" background-color:#fff; padding:40px 40px 25px; box-shadow: 0 0px 40px rgba(239,246,250,.9); border-radius: 15px;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic4.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 30px;" />
                                                ...
                                                <h4 class="themecolor"><i class="icon-phone themecolor"></i> +61 +92 331 2261586</h4>
                                                <hr class="no_line" style="margin: 0 auto 10px;" />
                                                <a class="button button_size_2 button_js" href="content/healthy/contact.html"><span class="button_label">Contact us</span></a>
                                            </div>
                                        </div>
                                        <div class="column mcb-column mcb-item-i1j06muxa one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" background-color:#fff; padding:40px 40px 25px; box-shadow: 0 0px 40px rgba(239,246,250,.9); border-radius: 15px;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic5.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 30px;" />
                                                <h4>Our Doctors</h4>
                        ...
                        <div class="section mcb-section mcb-section-jz4gtjfxe equal-height-wrap" style="padding-top:70px; padding-bottom:0px; background-color:">
                            <div class="section_wrapper mcb-section-inner">
                                <div class="wrap mcb-wrap mcb-wrap-fyn21m3x3 two-third valign-middle clearfix">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-6c7rm9uc1 one column_image">
                                            <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                                                <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic6.jpg')}}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="wrap mcb-wrap mcb-wrap-6508cn8v9 one-third valign-middle clearfix" style="padding:0 0 0 5%">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-o3vyeix7m one column_column">
                        ...
                        <div class="section mcb-section mcb-section-i53hg1sxq" style="padding-top:70px; padding-bottom:0px; background-color:">
                            <div class="section_wrapper mcb-section-inner">
                                <div class="wrap mcb-wrap mcb-wrap-da3wq7gdu one valign-top clearfix">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-cb72cuc00 one column_column">
                                ...
                                <div class="wrap mcb-wrap mcb-wrap-ijali9oyj one-third valign-top clearfix" style="padding:0 1%">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-zp2ub8tzy one column_image">
                                            <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                                                <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic32.jpg')}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column mcb-column mcb-item-ojma4n1yf one column_column">
                                            <div class="column_attr clearfix align_center">
                                ...
                                <div class="wrap mcb-wrap mcb-wrap-t4ll8v8ek one-third valign-top clearfix" style="padding:0 1%">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-uluw7x4ui one column_image">
                                            <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                                                <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic33.jpg')}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column mcb-column mcb-item-xilkaoax7 one column_column">
                                            <div class="column_attr clearfix align_center">
                                ...
                                <div class="wrap mcb-wrap mcb-wrap-swu781fdm one-third valign-top clearfix" style="padding:0 1%">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-qtcbcebry one column_image">
                                            <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                                                <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic34.jpg')}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column mcb-column mcb-item-6hx9ke5os one column_column">
                                            <div class="column_attr clearfix align_center">
                        ...
                        <div class="section mcb-section mcb-section-h0eb72ehi" style="padding-top:70px; padding-bottom:70px; background-color:">
                            <div class="section_wrapper mcb-section-inner">
                                <div class="wrap mcb-wrap mcb-wrap-wzbnskpkm one-third valign-top clearfix" style="padding:0 5%0 0">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-9aq0tpfn6 one column_column">
                                            <div class="column_attr clearfix">
                                                <h2>Our services</h2>
                                                <hr class="no_line" style="margin: 0 auto 15px;" />
                                                <p>
                                ...
                                <div class="wrap mcb-wrap mcb-wrap-n6si9avj9 two-third valign-top clearfix">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-mjpakc30w one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" padding:30px 0 15px; border-right: 1px solid #eff6fa;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic10.png')}}" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="column mcb-column mcb-item-30idyim3a one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" padding:30px 0 15px; border-right: 1px solid #eff6fa;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic11.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 25px;" />
                                                <h5>Dentistry</h5>
                                        ...
                                        <div class="column mcb-column mcb-item-q2xrkr5pw one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" padding:30px 0 15px;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic12.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 25px;" />
                                                <h5>Injection</h5>
                                        ...
                                        <div class="column mcb-column mcb-item-jpxcfraks one column_divider">
                                            <hr class="no_line" />
                                        </div>
                                        <div class="column mcb-column mcb-item-2glcdy2vp one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" padding:30px 0 15px; border-right: 1px solid #eff6fa;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic13.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 25px;" />
                                                <h5>Cardiology</h5>
                                        ...
                                        <div class="column mcb-column mcb-item-e7ujzzk72 one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" padding:30px 0 15px; border-right: 1px solid #eff6fa;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic14.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 25px;" />
                                        ...
                                        <div class="column mcb-column mcb-item-4tx46s04h one-third column_column">
                                            <div class="column_attr clearfix align_center" style=" padding:30px 0 15px;">
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/home_healthy_pic15.png')}}" />
                                                    </div>
                                                </div>
                                                <hr class="no_line" style="margin: 0 auto 25px;" />
                                                <h5>X-Ray</h5>
                        ...
                        <div class="section mcb-section mcb-section-v3x3x7xf5 highlight-right bg-cover" style="padding-top:0px; padding-bottom:0px; background-image:url({{asset('website/pages/images/home_healthy_pic17.jpg')}}); background-repeat:no-repeat; background-position:center top;">
                            <div class="section_wrapper mcb-section-inner">
                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column mcb-item-rtdn6lhhm one column_column">
                                            <div class="column_attr clearfix">
                                                ...
                                                <h3 class="themecolor"> +92 331 2261586</h3>
                                                <hr class="no_line" style="margin: 0 auto 15px;" />
                                                <p>
                    ...
                    <div class="column one-fourth">
                        <aside class="widget_text widget widget_custom_html">
                            <div class="textwidget custom-html-widget">
                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                    <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('website/pages/images/healthy.png')}}" />
                                    </div>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="column one-fourth">
                        <aside class="widget_text widget widget_custom_html">
                            <div class="textwidget custom-html-widget">
                                ...
                                <p class="big">
                                    <a href="care@brandsoftsols.com">care@brandsoftsols.com</a>
                                </p>
                            </div>
                        </aside>
                    </div>
            ...
            <div class="footer_copy">
                <div class="container">
                    <div class="column one">
                        ...
                        <div class="copyright">
                            &copy; 2021 HealthyBee - <a target="_blank" rel="nofollow" href="https://brandsoftsols.com/">Brandsoftsolution</a>
    ...
    <div id="Side_slide" class="right dark" data-width="250">
        ...
        <div class="extras">
            <a href="#" class="action_button" target="_blank">BOOK NOW <i class="icon-right-open"></i></a>
    ...
    <script src="{{asset('website/js/mfn.menu.js')}}"></script>
    <script src="{{asset('website/js/jquery.plugins.js')}}"></script>
    <script src="{{asset('website/js/jquery.jplayer.min.js')}}"></script>
    <script src="{{asset('website/js/animations/animations.js')}}"></script>
    <script src="{{asset('website/js/translate3d.js')}}"></script>
    <script src="{{asset('website/js/scripts.js')}}"></script>


    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/jquery.themepunch.tools.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/jquery.themepunch.revolution.min.js')}}"></script>

    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.video.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.actions.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.navigation.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.migration.min.js')}}"></script>
    <script src="{{asset('website/pages/plugins/rs-plugin-5.3.1/js/extensions/revolution.extension.parallax.min.js')}}"></script>
