...
class DoctortProfileController extends Controller
{
    public function view(){
        
        $user = Auth::user();
        $patient = Doctor::where('user_id' , $user->id)->first();
        return view('doctor.profile.view', compact('user','patient'));
    ...
    public function edit()
    {
        $user = Auth::user();
        $patient = Doctor::where('user_id', $user->id)->first();
        return view('doctor.profile.edit', compact('user','patient'));
    }
